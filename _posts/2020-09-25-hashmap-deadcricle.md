---
title: 老生常谈，HashMap的死循环
layout: post
subtitle: 最近的几次面试中，我都问了是否了解HashMap在并发使用时可能发生死循环，导致cpu100%，结果让我很意外，都表示不知道有这样的问题，让我意外的是面试者的工作年限都不短。
author: 墒田
header-img: img/hash-1.png
header-mask: 0.4
tags:
  - hashmap
  - 死循环
...
![img](/img/hash-8.png)
    ...
    - newTable[i] = e 把节点a放到了数组i位置；
    - e = next; 把变量e赋值为null，因为第一步中变量next就是指向null；
