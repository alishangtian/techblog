...
<!-- TOC -->autoauto- [Raft算法](#raft算法)auto    - [说明](#说明)auto    - [架构](#架构)auto        - [系统中每个结点有三个组件：](#系统中每个结点有三个组件)auto        - [协议内容](#协议内容)auto        - [Leader election](#leader-election)auto        - [Log Replication](#log-replication)auto        - [Safety](#safety)auto        - [对协议的一点修正](#对协议的一点修正)auto        - [Log Compaction](#log-compaction)auto        - [集群拓扑变化](#集群拓扑变化)auto        - [参考 <https://raft.github.io/raft.pdf>](#参考-httpsraftgithubioraftpdf)autoauto<!-- /TOC -->
